...
function M.config()
  ...
  local cfg = require("yaml-companion").setup({
    lspconfig = {
      -- Neovim 0.11 removed client.workspace_did_change_configuration.
      -- Shim it back before yaml-companion's on_attach tries to call it.
    ...
    schemas = {
      {
        name = "Kubernetes 1.34.6",
        uri = "https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.34.6/all.json",
      },
      {
        name = "flux2",
