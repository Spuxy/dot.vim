...
local function get_gps()
  ...
  local status_loc_ok, gps_location = pcall(navic.get_location, {})
  if not status_loc_ok then
    return ""
  end
...
local function excludes()
  return vim.tbl_contains(M.winbar_filetype_exclude, vim.bo.filetype)
end
...
local function get_winbar()
  ...
  if not isempty(value) and vim.bo.modified then
